...
This is an organization for the Fall 26' class on computational systems for visual art and design.

## Getting Started
1. Once you receive an invite, create a new repository in this GitHub organization. 
Use your first name (no spaces) as the repository name. Do not initialize a README, add a gitignore, or a license.

2. Open the [student_sample repository](https://github.com/CSVAD26/studentsamplefolder) in the organization. This is a template I've created to help you set up your own repository. 
...
## Resources
Weekly examples for all projects are available in this organization in the [codeexamples](https://github.com/CSVAD26/code_examples) repository.
